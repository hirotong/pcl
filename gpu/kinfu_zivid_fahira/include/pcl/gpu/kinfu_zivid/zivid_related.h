...
const float c_x1 = 958.966391511045;
const float c_y1 = 574.974260360609;
// const float c_x1 = 959.119079589844;//from zdf
// const float c_y1 = 573.3330078125;

// CX : 958.966391511045 CY : 574.974260360609//from setting
...
*/
// friburg2 desk
const float f_x1 = 520.908620f;
const float f_y1 = 521.007327f;
const float c_x1 = 325.141442f;
const float c_y1 = 249.701764f;
